...
for string in cols:     
    ...
    if sub in string:
        print(string)
        percentCols.insert(count, string)
        count+=1

print(percentCols)

for x in percentCols:
    print(x)
...
for string in percentCols:                                                     # for x in list of columns with numbers split according to (
    string = string.split("(")
...
df2.to_csv(r'Financial Aid\percentFirstTime.csv')
print(df2)