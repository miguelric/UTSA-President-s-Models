...
df = pd.read_csv(r'Retention and Gradution\fourYearGrad_2004-2019.csv')             # Read necessary csv
...
while count2 < go:
    ...
    try:
        print(splitAtUnder[count2][2])
        numsWithF.insert(count2, splitAtUnder[count2][2])
        count2+=1
    except:
        print(splitAtUnder[count2][1])
...
df2.to_csv(r'Retention and Gradution\fourYearRet.csv')
print(df2)
